...
using WeatherForecastPublic.Api.Middlewares;
using WeatherForecastPublic.Infrastructure;
using WeatherForecastPublic.Infrastructure.Data;
using WeatherForecastPublic.Infrastructure.Messaging;
...
namespace WeatherForecastPublic.Api
{
    public class Startup(IConfiguration configuration, IWebHostEnvironment env)
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Weather Public User API V1");
            ...
            var serviceBusReceiver = app.ApplicationServices.GetRequiredService<ServiceBusReceiver>();
            serviceBusReceiver.RegisterMessageHandler();
        }
    }
}
